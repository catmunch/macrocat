...
sed '2s/preview/top/' sandwich.scad | openscad - --export-format asciistl -o "top case.stl"
mv "top case.stl" "export"

echo "========================"
echo "Compiling bottom case"
sed '2s/preview/bottom/' sandwich.scad | openscad - --export-format asciistl -o "bottom case.stl"
mv "bottom case.stl" "export"

echo "========================"
echo "Compiling plate"
sed '2s/preview/plate/' sandwich.scad | openscad - -o "plate.dxf"
mv "plate.dxf" "export"
